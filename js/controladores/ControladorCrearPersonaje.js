...
function crearPersonaje(array) {
  ...
  let inventario = new Inventario(9, []);
  inventario.addArma(arma);
  let jugador = new Jugador(nombre, fuerza, 100, 100, magia, magia, 1, idImg, arma, 0, 250, inventario);
  array.push(jugador);
}
...
function crearTienda(array) {
  let arma1 = new Arma("Longclaw", 40, "Intermedia", 100, "../recursos/imagenes/armas/Arma1.webp", false);
...
function crearRegiones(array) {
  ...
  // Segunda región
  let berserker = new Enemigo("Berserker", 40, 80, 80, 40, 40, 4, "../recursos/imagenes/regiones/Skellige/enemigos/Berserker.webp");
  let sirena = new Enemigo("Sirena", 50, 90, 90, 50, 50, 5, "../recursos/imagenes/regiones/Skellige/enemigos/Sirena.webp");
  let eredin = new Enemigo("Eredin", 60, 100, 100, 60, 60, 6, "../recursos/imagenes/regiones/Skellige/enemigos/Eredin.webp");
  ...
  // Tercera región
  let caballero = new Enemigo("Caballero", 70, 110, 110, 70, 70, 7, "../recursos/imagenes/regiones/Toussaint/enemigos/Caballero.webp");
  let golyat = new Enemigo("Golyat", 80, 120, 120, 80, 80, 8, "../recursos/imagenes/regiones/Toussaint/enemigos/Golyat.webp");
  let vampiro = new Enemigo("Vampiro", 90, 130, 130, 90, 90, 9, "../recursos/imagenes/regiones/Toussaint/enemigos/Vampiro.webp");
