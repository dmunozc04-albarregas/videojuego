 ...
 */
function selectWeapon(weapon, weaponDiv) {
    // Establecer el arma seleccionada
    armaSeleccionada = weapon;

    // Eliminar la clase 'selected' de todos los elementos y agregarla al elemento correspondiente
    document.querySelectorAll(".weapon-item").forEach(item => {
        item.classList.remove("selected");
    });
    weaponDiv.classList.add("selected");

    // Verificar que el objeto seleccionado sea una instancia válida de Arma
